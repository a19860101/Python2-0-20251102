...
is_tax = bool(input('含稅還是未稅？（含稅輸入1，未稅輸入0）'))
...
print(f'含稅價日幣為{tax_in}，台幣為{tax_in * jpy}')
print(f'未稅價日幣為{tax_out}，台幣為{tax_out * jpy}')
print(f'消費稅{tax}%')
print(f'日幣價差為{tax_in - tax_out}，台幣價差為{(tax_in - tax_out) * jpy}')